...
namespace Abim.Platform.Program.Tests.Scenarios.Domain.Credential
{
    [Story(
        ...
        IWant = "to make use of the ExpireAndReissue() method",
        SoThat = "so that I can properly expire and reissue issuances"
        )]
    [TestFixture]
    public class CredentialExpireAndReissueSpec
    {
        [Test]
        [WorkItem(183137)]
        ...
        private abstract class CredentialReissueScenarioBase
        {
            ...
            public void WhenICallExpireAndReissue()
            {
                try
                {
                    _sut.ExpireAndReissue(
                        _sut.OldestIssuance.Id, 
