...
namespace Abim.Platform.Program.Tests.Scenarios.Services.Lookback
{
    [Story(
        ...
        SoThat = "it can handle the AddCertificationLookbackLog Command"
        )]
    [TestFixture]
    public class AddCertificationLogEntryCommandSpec
    {
        [TestCase]
        ...
        /// </summary>
        /// <remarks>
        /// Base class for all AdCcertificationlogEntry scenarios
        /// </remarks>
        public abstract class AddCertificationLogEntryScenario : LookbackLogScenario
        {
        ...
        /// </remarks>
        public class ReturnsAcceptedScenario : AddCertificationLogEntryScenario
        {
            protected override void PostSetup()
            {
                ...
                My<IValidationFactory>()
                    .Setup(o => o.GetValidatorInstance<AddCertificationLookbackLog>())
                    .Returns(My<IValidator<AddCertificationLookbackLog>>().Object);

                My<IValidator<AddCertificationLookbackLog>>()
                    .Setup(o => o.Validate(It.IsAny<AddCertificationLookbackLog>()))
            ...
            {
                Command = CommandBuilder<AddCertificationLookbackLog>
                            .Valid()
        ...
        /// </remarks>
        public class ThrowsDatabaseExecptionScenario : AddCertificationLogEntryScenario
        {
            protected override void PostSetup()
            {
                var cert = Certification.Create(null, Source.Create(RandomString.Build(), RandomString.Build(), RandomString.Build()), EnumAttributes.RandomEntry<CertificationType>(), RandomString.Build(), RandomString.Build(), RandomString.Build());
        ...
        /// </remarks>
        public class CannotFindCredentialScenario : AddCertificationLogEntryScenario
        {
            protected override void PostSetup()
            {
