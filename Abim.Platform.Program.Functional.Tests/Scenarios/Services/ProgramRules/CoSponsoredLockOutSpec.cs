...
namespace Abim.Platform.Program.Tests.Scenarios.Services.ProgramRules
{
  ...
  SoThat = "it can run the Cosponsored Lock Out process"
    ...
    public class CoSponsoredLockOutSpec
    {
        ...
        [Test]
        [WorkItem(223712)]
        public void Should_Properly_Update_Credential_LockOutDate_During_LockOut_Process()
        {
            new ShouldProperlyUpdateCredentialLockOutDateDuringLockOutProcessScenario().BDDfy();
        }
        ...
        [Test]
        [WorkItem(223711)]
        public void Should_Set_LockOut_Period_TookMOCExam_AndFailed_During_LockOut_Process()
        {
            new ShouldSetLockOutPeriodWhenTookMocExamAndFailedScenario().BDDfy();
        }
        ...
        private class ShouldProperlyUpdateCredentialLockOutDateDuringLockOutProcessScenario : ProgramRulesServiceSimplifiedScenario
        {
            ...
            private void ThenVerifyUpdateCredentialFromLookBackCommand()
            {
                ...
                _credSvcMock.Verify(x => 
                        x.Handle(It.Is<UpdateCredentialFromLookbackCommand>(
                                ...
                                cmd.ModifiedBy == "CoSponsoredLockOut_" + _lockOutDate.ToString("yyyy-MM-dd"))), Times.Once);
            }
        }
        ...
        private class ShouldSetLockOutPeriodWhenTookMocExamAndFailedScenario : ProgramRulesServiceSimplifiedScenario
        {
            private Guid _credentialId;
            private DateTime _lockOutDate;
            private int _lockOutYear = 2022;
            ...
            protected override void SetupRegistrationInterserviceMock()
            {
                ...
                registrations.
                        Registrations.Add(RegistrationResourceDataBuilder
                                            .With(a => a.AdministrationYear = _lockOutYear)
                                            .With(a => a.CertificationId = _credential.Certification.ExternalId)
                                            .With(a => a.AdministrationDate = new DateTime(_lockOutYear, 11, 02))
                                            ...
                                            .With(a => a.Seats = new List<SeatRegistrationSummaryResource>() { new SeatRegistrationSummaryResource { SeatDate = new DateTime(_lockOutYear, 11, 02) } })
