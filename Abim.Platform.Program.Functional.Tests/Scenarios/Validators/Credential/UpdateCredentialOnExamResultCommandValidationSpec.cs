...
namespace Abim.Platform.Program.Tests.Scenarios.Validators.Credential
{
    ...
    [TestFixture]
    public class UpdateCredentialOnExamResultCommandValidationSpec
    {
        [Test]
        ...
        /// Command Builder
        /// </summary>
        public static class UpdateCredentialOnExamResultCommandBuilder
        {
            public static UpdateCredentialOnExamResultCommand BuildValid()
            {
                return CommandBuilder<UpdateCredentialOnExamResultCommand>
                            .Valid()
                            .Build();
            }
        }
        ...
        public abstract class UpdateCredentialOnExamResultCommandValidationBaseScenario
        {
            protected UpdateCredentialOnExamResultCommand _command;
            protected UpdateCredentialOnExamResultCommandValidator _validator;
            protected Exception _caughtException;
            protected ValidationResult _validationResult;

            protected virtual void Setup()
            {
                _validator = new UpdateCredentialOnExamResultCommandValidator();
            }
        }

        public class ShouldPassValidationWhenAllRequiredValuesArePresent
            : UpdateCredentialOnExamResultCommandValidationBaseScenario
        {
            private void GivenIHaveAValidCommand()
            {
                _command = UpdateCredentialOnExamResultCommandBuilder.BuildValid();
            }
        ...
        /// </summary>
        public abstract class UpdateCredentialOnExamResultCommandValidationFailureBaseScenario 
            : UpdateCredentialOnExamResultCommandValidationBaseScenario
        {
        ...
        private class ShouldFailValidationWhenCredentialIdIsNull
            : UpdateCredentialOnExamResultCommandValidationFailureBaseScenario
        {
