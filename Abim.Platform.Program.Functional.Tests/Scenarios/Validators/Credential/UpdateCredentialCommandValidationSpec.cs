...
namespace Abim.Platform.Program.Tests.Scenarios.Validators.Credential
{
    ...
    [TestFixture]
    public class UpdateCredentialCommandValidationSpec
    {
        [Test]
        ...
        [Test]
        public void Should_Fail_Validation_When_CertificationId_Is_Null()
        {
            new ShouldFailValidationWhenCertificationIdIsNull().BDDfy();
        }

        [Test]
        public void Should_Fail_Validation_When_MemberId_Is_Null()
        {
            new ShouldFailValidationWhenMemberIdIsNull().BDDfy();
        }
        ...
        /// Command Builder
        /// </summary>
        public static class UpdateCredentialCommandBuilder
        {
            public static UpdateCredentialCommand BuildValid()
            {
                return CommandBuilder<UpdateCredentialCommand>
                            .Valid()
        ...
        public abstract class UpdateCredentialCommandValidationBaseScenario
        {
            protected UpdateCredentialCommand _command;
            protected UpdateCredentialCommandValidator _validator;
            protected Exception _caughtException;
            protected ValidationResult _validationResult;

            protected virtual void Setup()
            {
                _validator = new UpdateCredentialCommandValidator();
            }
        }

        public class ShouldPassValidationWhenAllRequiredValuesArePresent
            : UpdateCredentialCommandValidationBaseScenario
        {
            private void GivenIHaveAValidCommand()
            {
                _command = UpdateCredentialCommandBuilder.BuildValid();
            }
        ...
        /// </summary>
        public abstract class UpdateCredentialCommandValidationFailureBaseScenario 
            : UpdateCredentialCommandValidationBaseScenario
        {
        ...
        private class ShouldFailValidationWhenCertificationIdIsNull
            : UpdateCredentialCommandValidationFailureBaseScenario
        {
            ...
            {
                _command.CertificationId = Guid.Empty;
            }
        }

        private class ShouldFailValidationWhenMemberIdIsNull
           : UpdateCredentialCommandValidationFailureBaseScenario
        {
            protected override string ExpectedErrorMessage()
            {
