...
namespace Abim.Platform.Program.Tests.Scenarios.Validators.Credential
{
    ...
    [TestFixture]
    public class UpdateCredentialGracePeriodGFValidationSpec
    {
        [Test]
        ...
        /// Command Builder
        /// </summary>
        public static class UpdateCredentialGracePeriodGFCommandBuilder
        {
            public static UpdateCredentialGracePeriodGFCommand BuildValid()
            {
                return CommandBuilder<UpdateCredentialGracePeriodGFCommand>
                            .Valid()
                            .Build();
            }
        }
        ...
        public abstract class UpdateCredentialGracePeriodGFCommandValidationBaseScenario
        {
            protected UpdateCredentialGracePeriodGFCommand _command;
            protected UpdateCredentialGracePeriodGFValidator _validator;
            protected Exception _caughtException;
            protected ValidationResult _validationResult;

            protected virtual void Setup()
            {
                _validator = new UpdateCredentialGracePeriodGFValidator();
            }
        }

        public class ShouldPassValidationWhenAllRequiredValuesArePresent
            : UpdateCredentialGracePeriodGFCommandValidationBaseScenario
        {
            private void GivenIHaveAValidCommand()
            {
                _command = UpdateCredentialGracePeriodGFCommandBuilder.BuildValid();
            }
        ...
        /// </summary>
        public abstract class UpdateCredentialGracePeriodGFCommandValidationFailureBaseScenario 
            : UpdateCredentialGracePeriodGFCommandValidationBaseScenario
        {
        ...
        private class ShouldFailValidationWhenCredentialIdIsNull
            : UpdateCredentialGracePeriodGFCommandValidationFailureBaseScenario
        {
