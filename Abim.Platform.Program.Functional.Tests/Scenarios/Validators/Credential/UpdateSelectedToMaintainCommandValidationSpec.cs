...
namespace Abim.Platform.Program.Tests.Scenarios.Validators.Credential
{
    ...
    [TestFixture]
    public class UpdateSelectedToMaintainCommandValidationSpec
    {
        [Test]
        ...
        /// Command Builder
        /// </summary>
        public static class UpdateSelectedToMaintainCommandBuilder
        {
            public static UpdateSelectedToMaintainCommand BuildValid()
            {
                return CommandBuilder<UpdateSelectedToMaintainCommand>
                            .Valid()
        ...
        public abstract class UpdateSelectedToMaintainCommandValidationBaseScenario
        {
            protected UpdateSelectedToMaintainCommand _command;
            protected UpdateSelectedToMaintainCommandValidator _validator;
            protected Exception _caughtException;
            protected ValidationResult _validationResult;

            protected virtual void Setup()
            {
                _validator = new UpdateSelectedToMaintainCommandValidator();
            }
        }

        public class ShouldPassValidationWhenAllRequiredValuesArePresent
            : UpdateSelectedToMaintainCommandValidationBaseScenario
        {
            private void GivenIHaveAValidCommand()
            {
                _command = UpdateSelectedToMaintainCommandBuilder.BuildValid();
            }
        ...
        /// </summary>
        public abstract class UpdateSelectedToMaintainCommandValidationFailureBaseScenario 
            : UpdateSelectedToMaintainCommandValidationBaseScenario
        {
        ...
        private class ShouldFailValidationWhenCredentialIdIsNull
            : UpdateSelectedToMaintainCommandValidationFailureBaseScenario
        {
        ...
        private class ShouldFailValidationWhenUserInfoIsNull : UpdateSelectedToMaintainCommandValidationFailureBaseScenario
        {
            protected override string ExpectedErrorMessage()
            {
        ...
        private class ShouldFailValidationWhenUserNameIsNull : UpdateSelectedToMaintainCommandValidationFailureBaseScenario
        {
            protected override string ExpectedErrorMessage()
            {
