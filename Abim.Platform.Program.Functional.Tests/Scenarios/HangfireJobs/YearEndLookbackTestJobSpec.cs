...
namespace Abim.Platform.Program.Tests.Scenarios.HangfireJobs
{
    [Story(
      ...
      IWant = "to be able to invoke the YearEndLookbackTestJob",
      SoThat = "it can perform test runs of the year end lookback process"
      )]
    [TestFixture]
    public class YearEndLookbackTestJobSpec
    {
        [Test]
        ...
        private abstract class YearEndLookbackTestJobSpecBase
        {
            protected YearEndLookbackTestJob _sut;
            ...
            {
                SetupMocks();
                _sut = new YearEndLookbackTestJob(
        ...
        private class ShouldQueryDatabaseForEligibleMemberIDs : YearEndLookbackTestJobSpecBase
        {
        ...
        private class ShouldThrowExceptionWhenCancellationTokenSaysCancel : YearEndLookbackTestJobSpecBase
        {
        ...
        private class ShouldEnqueueChildJobForEachMemberId : YearEndLookbackTestJobSpecBase
        {
            private void WhenTheMethodExecutesNoExceptionShouldHaveBeenCaught()
            {
                _caughtException.Should().BeNull();
