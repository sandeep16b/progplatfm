...
namespace Abim.Platform.Program.Integration.Scenarios.Controllers.Certification.Base
{
    public abstract class CertificationControllerScenario : BaseHttpServerScenario
    {
