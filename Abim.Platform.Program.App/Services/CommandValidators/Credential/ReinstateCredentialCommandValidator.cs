...
{
    /// <summary>
    /// The Validation class for the ReinstateCredentialCommand
    /// </summary>
    public class ReinstateCredentialCommandValidator : AbstractValidator<ReinstateCredentialCommand>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReinstateCredentialCommandValidator"/> class.
        /// </summary>
        public ReinstateCredentialCommandValidator()
        {
