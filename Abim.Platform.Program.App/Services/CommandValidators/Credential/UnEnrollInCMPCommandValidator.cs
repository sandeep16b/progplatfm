...
{
    /// <summary>
    /// The Validation class for the UnEnrollInCMPCommand
    /// </summary>
    public class UnEnrollInCMPCommandValidator : AbstractValidator<UnEnrollInCMPCommand>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UnEnrollInCMPCommand"/> class.
        /// </summary>
        public UnEnrollInCMPCommandValidator()
        {
            // MemberId / AbimId
            ...
            // EnrollmentDate
            RuleFor(o => o.UnEnrollmentDate).Must(NotTooOldDate)
                .WithMessage("UnEnrollmentDate may not be prior to 1936");

            RuleFor(o => o.UnEnrollmentDate).Must(NotTooFutureDate)
                .WithMessage("UnEnrollmentDate may not be more than 3 years in the future");
